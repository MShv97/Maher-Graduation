...
const User = new Schema(
	{
		...
		about: { type: String },
		documents: { type: [Schema.Types.ObjectId], ref: 'File', default: undefined, autopopulate: true },
...
User.statics = {
	...
	auth: async function (filters) {
		const result = await this.findOne(filters, '-createdAt -updatedAt -lastLogin -avatar');
		if (!result) return;
